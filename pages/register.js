...
export default function Register() {
    ...
    const handleFormSubmit = e => {
        ...
        axios.post(`https://hcodelab-adonis.herokuapp.com/users`, values)
            .then(res => {
                // alert(`Olá ${res.name} seus dados foram cadastrados ID: ${res.id}`)
                ...
                <section>
                    ...
                    <form onSubmit={handleFormSubmit} className={styles.form}>
                        <div>
                            ...
                            <div className={styles.fields}>
                                <div className={styles.field}>
                                    <input type="date" name="birth" id="birth" onSubmit={handleFormSubmit} />
                                    <label htmlFor="birth_at">Data de Nascimento</label>
                                </div>
                                <div className={styles.field}>
                                    <input type="password" name="password" id="password" onChange={handleInputChange} onSubmit={handleFormSubmit} />
